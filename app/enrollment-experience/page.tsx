...
export default function EnrollmentExperiencePage() {
    ...
    try {
      const response = await fetch('/api/google-sheets-direct', {
        ...
        body: JSON.stringify({
          ...
          name,
          mobile,
          reviewType: 'Enrollment Experience'
        }),
      });
          ...
          <div className="flex items-center justify-center order-1 lg:order-2 mb-4 lg:mb-0">
            <div className="relative w-full max-w-[95vw] sm:max-w-md overflow-hidden rounded-2xl shadow-xl">
              ...
              <div className="relative z-10 px-8 pt-8 pb-8 sm:px-12 sm:py-[50px]">
                ...
                <h1 className="text-2xl font-semibold text-white mb-2 tracking-tighter">Share Your Enrollment Experience</h1>
                <p className="text-white/70 text-xs leading-relaxed">
                  Help us improve by sharing your <span className="text-white">enrollment experience</span>
                </p>
